...
namespace DVLD_Business
{
    public class clsLicenseClass
    {
        ...
        public static clsLicenseClass FindLicenseClass(string ClassName)
        {
            ...
            bool IsFound = clsLicenseClassesData.GetLicenseClassInfoByName
                                (
                                    ClassName,ref LicenseClassID,
        ...
        public bool Delete()
        {
            return clsLicenseClassesData.DeleteLicenseClass(this.LicenseClassID);
        }
