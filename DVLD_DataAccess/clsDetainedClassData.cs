...
{
    public class clsDetainedClassData
    {
        public static bool GetDetainedLicensefoByID(int LicenseID,
 ref int DetainID, 
ref DateTime DetainDate,ref float FineFees,ref int CreatedByUserID,ref bool IsReleased,ref DateTime ReleaseDate,
ref int ReleasedByUserID,ref int ReleaseApplicationID
        ...
        public static bool GetDetainedLicensefoByLicenseID(int LicenseID ,
ref int DetainID,
ref DateTime DetainDate, ref float FineFees, ref int CreatedByUserID, ref bool IsReleased, ref DateTime ReleaseDate,
ref int ReleasedByUserID, ref int ReleaseApplicationID
)
        ...
        public static int  AddDetainLicense(int LicenseID,DateTime DetainDate,float FineFees, int CreatedByUserID
)
        {
