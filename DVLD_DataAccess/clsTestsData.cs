...
ref int TestAppointmentID,ref bool TestResult,ref string Notes, ref int CreatedByUserID)
        ...
        public static byte GetPassedTestCount(int LocalDrivingLicenseApplicationID)
        {
            ...
            string query = @"SELECT PassesdTestCount = count(TestTypeID) FROM Tests INNER JOIN
           ...
           ref int TestID,ref int TestAppointmentID,ref bool TestResult,ref string Notes,ref int CreatedByUserID)
        {
            ...
            string query = @"SELECT top 1 Tests.TestID,
                           Tests.TestAppointmentID,Tests.TestResult,Tests.Notes,Tests.CreatedByUserID,
                          Applications.ApplicantPersonID FROM 
