...
namespace DVLD_DataAccess
{
    ...
    {
        public static bool GetTestAppointmentLInfoByID(int TestAppointmentID,
...
ref float PaidFees, ref int CreatedByUserID,  ref bool IsLocked, ref int RetakeTestApplicationID )
        ...
        public static bool GetTestAppointmentLInfoByID(int LocalDrivingLicenseApplicationID, int TestTypeID,
...
ref float PaidFees, ref int CreatedByUserID, ref bool IsLocked, ref int RetakeTestApplicationID)
        {
            ...
            string query = @"SELECT TestAppointmentID, AppointmentDate, PaidFees,CreatedByUserID,
                     IsLocked,    RetakeTestApplicationID          FROM TestAppointments WHERE (TestTypeID = @TestTypeID)
            ...
            string query = @"select TestAppointmentID,AppointmentDate,PaidFees,IsLocked
                      From TestAppointments
                        WHERE(LocalDrivingLicenseApplicationID = @LocalDrivingLicenseApplicationID)
                         AND(TestTypeID= @TestTypeID)order by AppointmentDate Desc ";
